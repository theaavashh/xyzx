                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {Array.isArray(order.items) && order.items?.map((item: { name: string; quantity: number; price: number; reason?: string }, index: number) => (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                      ...
                      {Array.isArray(order.fees) && order.fees.length > 0 && (
                        <div className="flex justify-between">
                          <span className="text-sm font-medium text-gray-500">
                            Fees
                          </span>
                          <span className="text-sm font-medium text-gray-900">
                            {formatPrice(order.fees.reduce((sum: number, fee: { amount: number }) => sum + fee.amount, 0))}
                          </span>
                        </div>
                      )}
                    </div>
