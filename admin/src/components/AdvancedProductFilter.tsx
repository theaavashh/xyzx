        ...
        {isExpanded && (
          ...
          >
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <h4 className="text-md font-medium text-gray-900 custom-font">
                  Advanced Filters
                </h4>
                <button
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-xs text-gray-600 mb-1 custom-font">
                            Min Price
                          </label>
                          <Controller
                            name="priceMin"
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <label className="flex items-center">
                                ...
                                />
                                <span className="text-sm text-gray-700 custom-font">
                                  Featured Only
                                </span>
                              </label>
                            )}
                    ...
                    {/* Sort Options */}
                    <div>
                      <h5 className="text-sm font-medium text-gray-700 mb-3 custom-font">
                        Sort Options
                      </h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
