        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className={`absolute bottom-full mb-1 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50 ${
                isCollapsed
                  ? 'lg:left-4 lg:w-56 lg:right-auto lg:bottom-auto lg:top-1/2 lg:-translate-y-1/2'
                  : 'left-2 right-2'
              }`}
            >
