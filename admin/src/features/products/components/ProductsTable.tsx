        ...
        <table className="w-full min-w-[800px]">
          <thead>
            <tr className="border-b border-gray-100 bg-gray-50/80">
              ...
              <th className="w-10 px-2 py-2 text-center text-sm font-semibold text-gray-500 uppercase tracking-wider">#</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Image</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Product</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Variants</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Category</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Price</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Stock</th>
              <th className="px-4 py-2 text-left text-sm font-semibold text-gray-500 uppercase tracking-wider">Status</th>
            </tr>
          </thead>
