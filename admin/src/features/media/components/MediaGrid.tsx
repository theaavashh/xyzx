...
export default function MediaGrid({ items, onToggleActive, onEdit, onDelete }: MediaGridProps) {
  return (
          ...
          <div className="p-4">
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 truncate capitalize custom-font mb-2">
                  {item.linkTo.replace('-', ' ')}
                </h3>
