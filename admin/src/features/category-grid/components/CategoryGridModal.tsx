...
interface CategoryGridModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (form: CategoryGridForm) => Promise<void>;
  editingItem: CategoryGridItem | null;
  isUploading: boolean;
...
export function CategoryGridModal({
  ...
  const [form, setForm] = useState<CategoryGridForm>({
    title: '',
    subtitle: '',
    image: '',
    link: '',
            ...
            <form onSubmit={handleSubmit} className="space-y-6 p-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Timeless style. Modern spirit"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent text-black placeholder:text-gray-400"
                />
              </div>
