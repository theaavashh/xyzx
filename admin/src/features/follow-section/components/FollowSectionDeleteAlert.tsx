...
interface FollowSectionDeleteAlertProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  sectionName?: string;
...
export function FollowSectionDeleteAlert({
  isOpen,
  onClose,
  onConfirm,
  sectionName,
  isPending,
}: FollowSectionDeleteAlertProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
        ...
        >
          ...
          >
            <h3 className="text-base font-semibold text-gray-900 mb-1">
              Delete &ldquo;{sectionName || 'this section'}&rdquo;?
            </h3>
