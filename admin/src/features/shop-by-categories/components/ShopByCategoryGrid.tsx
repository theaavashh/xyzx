...
import type { ShopByCategory } from '../types';

interface ShopByCategoryGridProps {
  items: ShopByCategory[];
  isLoading: boolean;
  onEdit: (item: ShopByCategory) => void;
  onToggle: (item: ShopByCategory) => void;
  onDelete: (item: ShopByCategory) => void;
    ...
    return (
      <div className="text-center py-12">
        ...
        <button
          type="button"
          onClick={onAdd}
          className="inline-flex items-center gap-2 bg-[#D4AF37] text-white px-4 py-2.5 lastik text-lg rounded-md hover:bg-[#b8962e] focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition-all font-semibold"
        >
