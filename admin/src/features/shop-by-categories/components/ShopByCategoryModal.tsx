...
interface ShopByCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (form: ShopByCategoryForm) => Promise<void>;
  editingItem: ShopByCategory | null;
  isUploading: boolean;
  onUploadImage: (file: File) => Promise<string | null>;
}

export function ShopByCategoryModal({
  isOpen,
  onClose,
  onSubmit,
  editingItem,
  isUploading,
  onUploadImage,
}: ShopByCategoryModalProps) {
  const [form, setForm] = useState<ShopByCategoryForm>({
    title: '',
    image: '',
    link: '',
    isActive: true,
  ...
  const handleFormChange = (
    field: keyof ShopByCategoryForm,
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="/categories/shoes or https://example.com/categories/shoes"
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Internal link example: /categories/shoes or External:
                    https://example.com
                  </p>
                </div>
                    ...
                    <div className="relative">
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.currentTarget.src = '';
                          e.currentTarget.alt =
                            'Failed to load image - check console';
                        }}
                      />
                      <button
                        type="button"
