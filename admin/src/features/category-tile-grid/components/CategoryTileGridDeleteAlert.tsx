...
interface CategoryTileGridDeleteAlertProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isPending?: boolean;
...
export function CategoryTileGridDeleteAlert({ isOpen, onClose, onConfirm, isPending }: CategoryTileGridDeleteAlertProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
