      ...
      <DashboardLayout title="Point of Sale">
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center max-w-md">
            ...
            <h2 className="text-2xl font-bold text-black lastik mb-2">Sale Complete!</h2>
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button onClick={resetSuccess} className="bg-[#D4AF37] text-white px-8 py-3 rounded-lg font-medium lastik text-lg hover:bg-[#b8962e] transition-colors">
                New Sale
              </button>
            </div>
          </div>
    ...
    return (
      <DashboardLayout title="Point of Sale">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-black lastik">Sales History</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase lastik">Order #</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase lastik">Date</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase lastik">Customer</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase lastik">Total</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase lastik">Payment</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase lastik">Actions</th>
              </tr>
            </thead>
  ...
  return (
    <DashboardLayout title="Point of Sale">
      <div className="flex gap-3 mb-4">
          ...
          className={`px-4 py-2.5 lastik text-lg rounded-md transition-all ${tab === 'new-sale' ? 'bg-[#D4AF37] text-white' : 'bg-white text-black border border-gray-200 hover:bg-gray-50'}`}>
          New Sale
        </button>
        <button onClick={() => setTab('history')}
          className="px-4 py-2.5 lastik text-lg rounded-md bg-white text-black border border-gray-200 hover:bg-gray-50 transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-[calc(100vh-10rem)]">
        <div className="lg:col-span-7 bg-white rounded-xl border border-gray-200 flex flex-col">
          <div className="p-5 border-b border-gray-200">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-black lastik">Products</h2>
        ...
        <div className="lg:col-span-5 bg-white rounded-xl border border-gray-200 flex flex-col">
          <div className="p-5 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-black lastik flex items-center gap-2"><ShoppingCart className="w-5 h-5" /> Bill</h2>
          ...
          {cart.length > 0 && (
            <div className="px-4 py-3 border-t border-gray-200">
              <div className="flex items-center gap-2 mb-2"><Percent className="w-4 h-4 text-gray-500" /> <span className="text-sm font-medium text-black lastik">Discount</span></div>
              <div className="flex gap-2">
                <div className="flex gap-1">
                  <button onClick={() => setDiscountType('percent')}
                    className={`px-3 py-1.5 lastik text-sm rounded-md ${discountType === 'percent' ? 'bg-[#D4AF37] text-white' : 'bg-gray-100 text-black border border-gray-300'}`}>%</button>
                  <button onClick={() => setDiscountType('fixed')}
                    className={`px-3 py-1.5 lastik text-sm rounded-md ${discountType === 'fixed' ? 'bg-[#D4AF37] text-white' : 'bg-gray-100 text-black border border-gray-300'}`}>NPR</button>
                </div>
          ...
          {cart.length > 0 && (
            <div className="px-4 py-3 border-t border-gray-200">
              <span className="text-sm font-medium text-black lastik mb-2 block">Payment Method</span>
            ...
            <div className="p-5 border-t border-gray-200 space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={handleCheckout} disabled={cart.length === 0 || processing}
                  className="flex-1 bg-[#D4AF37] text-white py-4 rounded-lg font-bold lastik text-lg hover:bg-[#b8962e] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
