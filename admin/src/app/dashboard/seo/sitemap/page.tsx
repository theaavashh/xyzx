      ...
      <div className="space-y-2 max-w-7xl">
        <div className="rounded-xl p-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-black lastik">Sitemap Management</h1>
            ...
            <div className="flex space-x-2">
              ...
              <button type="button" onClick={() => handleTabChange('xml')}
                className={`px-4 py-2.5 rounded-md font-medium text-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition-all lastik ${activeTab === 'xml' ? 'bg-[#D4AF37] text-white' : 'bg-gray-100 text-black hover:bg-gray-200'}`}>
                XML Editor
              </button>
            </div>
          </div>
        ...
        {activeTab === 'visual' ? (
          <>
            <div className="bg-white rounded-md border border-gray-200 p-4">
              <h2 className="text-lg font-bold text-black lastik mb-4">{editingIndex !== null ? 'Edit URL' : 'Add New URL'}</h2>
            ...
            <div className="bg-white rounded-md border border-gray-200 p-4">
              <h2 className="text-lg font-bold text-black lastik mb-4">Bulk Actions</h2>
              <div className="flex space-x-2">
            ...
            <div className="bg-white rounded-md border border-gray-200 p-4">
              <h2 className="text-lg font-bold text-black lastik mb-4">Sitemap URLs</h2>
              {urls.length === 0 ? (
          ...
          <div className="bg-white rounded-md border border-gray-200 p-4">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-bold text-black lastik">XML Editor</h2>
        ...
        <div className="bg-[#D4AF37]/5 rounded-lg border border-[#D4AF37]/20 p-4">
          <h2 className="text-lg font-bold text-black lastik mb-4">SEO Best Practices</h2>
