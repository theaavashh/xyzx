      ...
      <div className="space-y-2 max-w-7xl">
        <div className="rounded-xl p-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-black">JSON-LD Management</h1>
            ...
            <div className="flex space-x-2">
              <button type="button" onClick={() => setActiveTab('visual')}
                className={`px-4 py-2.5 rounded-md font-medium text-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition-all ${activeTab === 'visual' ? 'bg-[#D4AF37] text-white' : 'bg-gray-100 text-black hover:bg-gray-200'}`}>Visual Editor</button>
              <button type="button" onClick={() => setActiveTab('editor')}
                className={`px-4 py-2.5 rounded-md font-medium text-sm focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition-all ${activeTab === 'editor' ? 'bg-[#D4AF37] text-white' : 'bg-gray-100 text-black hover:bg-gray-200'}`}>JSON Editor</button>
            </div>
          </div>
        </div>
        ...
        {activeTab === 'visual' ? (
          <>
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <h2 className="text-lg font-bold text-black mb-4">{isEditing ? 'Edit Script' : 'Add New Script'}</h2>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-bold text-black">JSON-LD Scripts ({scripts.length})</h2>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-bold text-black">JSON Editor</h2>
              <div className="flex space-x-2">
        ...
        <div className="bg-[#D4AF37]/5 rounded-lg border border-[#D4AF37]/20 p-4">
          <h2 className="text-lg font-bold text-black mb-4">JSON-LD Best Practices</h2>
