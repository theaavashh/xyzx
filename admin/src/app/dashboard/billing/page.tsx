...
export default function BillingPage() {
  ...
  const {
    orders, stats, isLoading, pagination, searchTerm, setSearchTerm,
    statusFilter, setStatusFilter, paymentStatusFilter, setPaymentStatusFilter,
    selectedOrder, showOrderModal, setPagination, handleSearch,
    viewOrderDetails, closeOrderModal, loadOrders, getStatusColor,
    getPaymentStatusColor, getStatusIcon, formatCurrency, formatDate,
  } = useBillingQueries();
    ...
    <DashboardLayout title="Billing">
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-black lastik">Billing Management</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button type="button" onClick={loadOrders} disabled={isLoading}
              className="flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-black rounded-md hover:bg-gray-200 transition-colors disabled:opacity-50 font-medium">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              ...
              <motion.div initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }}
                ...
                <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
                  <h2 className="text-2xl font-semibold text-black lastik">Filter Orders</h2>
        ...
        <OrderDetailsModal order={selectedOrder} show={showOrderModal} onClose={closeOrderModal}
