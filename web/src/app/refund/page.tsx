    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="text-center mb-14">
          ...
          <h1 className="lastik text-3xl sm:text-4xl md:text-5xl text-black mb-4">Refund Policy</h1>
        ...
        <div className="max-w-none space-y-12">
          <section>
            <h2 className="lastik text-2xl md:text-3xl text-black mb-6">
              1. Our Return Policy
            </h2>
            ...
            <div className="bg-black/5 p-6 md:p-8 rounded-xl border border-black/10">
              <p className="lastik text-lg text-black mb-2">
              ...
              <div className="border border-black/10 rounded-xl p-6">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-2 text-black/50 text-sm">
          ...
          <section>
            <h2 className="lastik text-2xl md:text-3xl text-black mb-6">3. Return Process</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="group flex gap-5 p-5 rounded-xl border border-black/10 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                  ...
                  <div>
                    <p className="text-xs text-black/40 uppercase tracking-wider mb-0.5">{s.step}</p>
                    <h3 className="font-semibold text-black text-sm mb-1 group-hover:translate-x-0.5 transition-transform duration-300">{s.title}</h3>
          ...
          <section>
            <h2 className="lastik text-2xl md:text-3xl text-black mb-6">4. Refund Options</h2>
            <div className="grid md:grid-cols-3 gap-5">
              {[
                ...
                <div key={i} className="group border border-black/10 rounded-xl p-6 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
                  ...
                  <h3 className="font-semibold text-black text-sm mb-2 group-hover:translate-x-0.5 transition-transform duration-300">{opt.title}</h3>
                  <p className="text-black/50 text-sm leading-relaxed">{opt.desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="border border-black/10 rounded-xl p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                <h3 className="font-semibold text-black text-sm mb-2">Free Returns for Defective Items</h3>
              ...
              <div className="border border-black/10 rounded-xl p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                <h3 className="font-semibold text-black text-sm mb-2">Customer Returns</h3>
                <p className="text-black/50 text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              {[
                ...
                <div key={i} className="border border-black/10 rounded-xl p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                  <h3 className="font-semibold text-black text-sm mb-2">{exc.title}</h3>
                  <p className="text-black/50 text-sm leading-relaxed">{exc.desc}</p>
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="bg-black/5 rounded-xl border border-black/10 p-6 space-y-3">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <span className="text-xs font-semibold text-black/40 uppercase tracking-wider w-16 shrink-0">{c.label}</span>
                  <span className="text-black text-sm">{c.value}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="bg-black/5 rounded-xl border border-black/10 p-8 md:p-10 text-center">
            <h2 className="lastik text-2xl md:text-3xl text-black mb-4">
              Customer Satisfaction Guarantee
            </h2>
            <p className="text-black/50 leading-relaxed max-w-2xl mx-auto">
