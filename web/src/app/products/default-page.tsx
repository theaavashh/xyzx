        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-64 flex-shrink-0">
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="text-sm text-gray-700">Hoodies</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">Crew Neck</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">Full Zip</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">Sweatshirts</span>
                  </label>
                </div>
              </div>
              ...
              {/* Fit */}
              <div>
                <h3 className="font-medium text-gray-900 mb-3">Fit</h3>
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">Oversized</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center">
                    ...
                    />
                    <span className="text-sm text-gray-700">Slim</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="text-sm text-gray-700">XS (0-2)</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">S (4-6)</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">M (8-10)</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">L (12-14)</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
                    ...
                    />
                    <span className="text-sm text-gray-700">XL (16-18)</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="text-sm text-gray-700">$0 - $50</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="checkbox"
