              ...
              <div key={order.id} className="bg-white border border-gray-100 rounded-xl overflow-hidden hover:border-gray-200 transition-colors">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-6 bg-gray-50/50 border-b border-gray-100 gap-4">
                  <div className="flex flex-wrap items-center gap-x-8 gap-y-2">
                    <div>
                      ...
                      <p className="text-sm font-semibold text-zinc-600">{new Date(order.date).toLocaleDateString()}</p>
                    </div>
                    <div>
                ...
                <div className="p-6">
                    ...
                    {order.items.slice(0, 3).map((item) => (
                      <div key={item.id} className="flex items-center gap-4 py-4 first:pt-0 last:pb-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="text-sm font-medium text-zinc-600 truncate">{item.productName}</h4>
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-8 pt-6 border-t border-gray-50">
                    ...
                    <button className="flex-1 sm:flex-none inline-flex items-center justify-center px-6 py-2.5 border border-gray-200 text-zinc-600 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors">
                      Track Order
                    </button>
